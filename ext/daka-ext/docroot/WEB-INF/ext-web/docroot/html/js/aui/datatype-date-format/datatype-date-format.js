...
var Dt = {
	formats: {
		...
		j: function (d) {
				var gmd_1 = new PersianDate("" + d.getFullYear() + "/1/1 GMT");
				var gmdate = new PersianDate("" + d.getFullYear() + "/" + (d.getMonth()+1) + "/" + d.getDate() + " GMT");
				var ms = gmdate - gmd_1;
		...
		V: function (d) {
				...
				var dow1_1 = (new PersianDate("" + d.getFullYear() + "/1/1")).getDay();
				...
				if(idow === 53 && (new PersianDate("" + d.getFullYear() + "/12/31")).getDay() < 4)
				{
					idow = 1;
				}
				else if(idow === 0)
				{
					idow = Dt.formats.V(new PersianDate("" + (d.getFullYear()-1) + "/12/31"));
				}
 ...
 * <pre>
 *    var d = new PersianDate("2008/04/22");
