...
var Calendar = A.Component.create(
	{
		...
		prototype: {
			...
			getCurrentDate: function() {
				...
				return ( new PersianDate(date.year, date.month, date.day) );
			},
			...
			getDaysInMonth: function(year, month) {
		        ...
		        return ( 32 - new PersianDate(date.year, date.month, 32).getDate() );
		    },
			...
			getFirstDate: function(year, month) {
				...
				return ( new PersianDate(date.year, date.month, 1) );
			},
			...
			getLastDate: function(year, month) {
				...
				return ( new PersianDate(date.year, date.month, daysInMonth) );
			},
			...
			navigateMonth: function(offset) {
				...
				var date = new PersianDate(currentYear, currentMonth + offset);
			...
			parseDate: function(dateString) {
				...
				return ( dateString ? new PersianDate(dateString) : new PersianDate() );
			},
