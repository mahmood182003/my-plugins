AUI
		.add(
				...
				function(A) {
					/**
					 * The Calendar component is a UI control that enables users
					 * to choose one or more dates from a graphical calendar
					 * presented in a single month or multi month interface.
					...
					var L = A.Lang, isDate = L.isDate, isString = L.isString, isArray = L.isArray, isBoolean = L.isBoolean, isValue = L.isValue, isNumber = L.isNumber,

					toInt = L.toInt,

					DateMath = A.DataType.DateMath, WidgetStdMod = A.WidgetStdMod,

					EMPTY_STR = '', SPACE = ' ',

					ACTIVE = 'active', ALLOW_NONE = 'allowNone', ANCHOR = 'a', BLANK = 'blank', BLANK_DAYS = 'blankDays', BOUNDING_BOX = 'boundingBox', CALENDAR = 'calendar', CHILDREN = 'children', CIRCLE = 'circle', CLEARFIX = 'clearfix', CURRENT_DAY = 'currentDay', CURRENT_MONTH = 'currentMonth', CURRENT_YEAR = 'currentYear', DATA_DAY = 'data-day', DATA_MONTH = 'data-month', DATA_YEAR = 'data-year', DATES = 'dates', DATE_FORMAT = 'dateFormat', DAY = 'day', DEFAULT = 'default', DISABLED = 'disabled', DOT = '.', END = 'end', FIRST_DAY_OF_WEEK = 'firstDayOfWeek', HEADER = 'hd', HEADER_CONTENT_NODE = 'headerContentNode', HEADER_TITLE_NODE = 'headerTitleNode', HELPER = 'helper', HIDDEN = 'hidden', HOVER = 'hover', ICON = 'icon', ICON_NEXT_NODE = 'iconNextNode', ICON_PREV_NODE = 'iconPrevNode', LINK = 'link', LOCALE = 'locale', MAX_DATE = 'maxDate', MIN_DATE = 'minDate', MONTH = 'month', MONTHDAYS = 'monthdays', MONTH_DAYS = 'monthDays', MONTH_DAYS_NODE = 'monthDaysNode', NEXT = 'next', NONE = 'none', NONE_LINK_NODE = 'noneLinkNode', PADDING = 'padding', PADDING_DAYS_END = 'paddingDaysEnd', PADDING_DAYS_START = 'paddingDaysStart', PREV = 'prev', PREVIOUS = 'previous', SELECT_MULTIPLE_DATES = 'selectMultipleDates', SHOW_OTHER_MONTH = 'showOtherMonth', SHOW_TODAY = 'showToday', START = 'start', STATE = 'state', STRINGS = 'strings', TITLE = 'title', TODAY = 'today', TODAY_LINK_NODE = 'todayLinkNode', TRIANGLE = 'triangle', WEEK = 'week', WEEKDAYS = 'weekdays', WEEK_DAYS = 'weekDays', WEEK_DAYS_NODE = 'weekDaysNode',

					EV_CALENDAR_SELECT = 'calendar:select',

					getCN = A.getClassName,

					CSS_CALENDAR_DISABLED = getCN(CALENDAR, DISABLED), CSS_CALENDAR_LINK = getCN(CALENDAR, LINK), CSS_CALENDAR_LINK_NONE = getCN(
							CALENDAR, LINK, NONE), CSS_CALENDAR_LINK_TODAY = getCN(CALENDAR, LINK, TODAY), CSS_DAY = getCN(
							CALENDAR, DAY), CSS_DAY_MONTH = getCN(CALENDAR, DAY, MONTH), CSS_DAY_BLANK = getCN(
							CALENDAR, DAY, BLANK), CSS_DAY_PADDING_END = getCN(CALENDAR, DAY, PADDING, END), CSS_DAY_PADDING_START = getCN(
							CALENDAR, DAY, PADDING, START), CSS_HEADER = getCN(CALENDAR, HEADER), CSS_HELPER_CLEARFIX = getCN(
							HELPER, CLEARFIX), CSS_HELPER_HIDDEN = getCN(HELPER, HIDDEN), CSS_ICON = getCN(ICON), CSS_ICON_CIRCLE_TRIANGLE_L = getCN(
							ICON, CIRCLE, TRIANGLE, 'l'), CSS_ICON_CIRCLE_TRIANGLE_R = getCN(ICON, CIRCLE, TRIANGLE,
							'r'), CSS_MONTHDAYS = getCN(CALENDAR, MONTHDAYS), CSS_NEXT = getCN(CALENDAR, NEXT), CSS_PREV = getCN(
							CALENDAR, PREV), CSS_STATE_ACTIVE = getCN(STATE, ACTIVE), CSS_STATE_DEFAULT = getCN(STATE,
							DEFAULT), CSS_STATE_HOVER = getCN(STATE, HOVER), CSS_TITLE = getCN(CALENDAR, TITLE), CSS_WEEK = getCN(
							CALENDAR, WEEK), CSS_WEEKDAYS = getCN(CALENDAR, WEEKDAYS),

					EMPTY_DATES = [],

					INT_MATRIX_DAYS_LENGTH = 42, INT_MAX_PADDING_END = 14,

					TPL_CALENDAR_NONE_LINK = '<a href="#" class="'
							+ [ CSS_CALENDAR_LINK, CSS_CALENDAR_LINK_NONE ].join(SPACE) + '">{none}</a>',

					TPL_CALENDAR_TODAY_LINK = '<a href="#" class="'
							+ [ CSS_CALENDAR_LINK, CSS_CALENDAR_LINK_TODAY ].join(SPACE) + '">{today}</a>',

					TPL_CALENDAR_HEADER = '<div class="'
							+ [ CSS_HEADER, CSS_STATE_DEFAULT, CSS_HELPER_CLEARFIX ].join(SPACE) + '"></div>',

					TPL_CALENDAR_PREV = '<a href="" class="'
							+ [ CSS_ICON, CSS_ICON_CIRCLE_TRIANGLE_L, CSS_PREV ].join(SPACE) + '">{previous}</a>',

					TPL_CALENDAR_NEXT = '<a href="" class="'
							+ [ CSS_ICON, CSS_ICON_CIRCLE_TRIANGLE_R, CSS_NEXT ].join(SPACE) + '">{next}</a>',

					TPL_CALENDAR_DAY_BLANK = '<div class="' + [ CSS_DAY_BLANK, CSS_HELPER_HIDDEN ].join(SPACE)
							+ '"></div>',

					TPL_CALENDAR_DAY_PADDING_START = '<div class="'
							+ [ CSS_DAY, CSS_STATE_DEFAULT, CSS_DAY_PADDING_START, CSS_HELPER_HIDDEN ].join(SPACE)
							+ '"></div>',

					TPL_CALENDAR_DAY_PADDING_END = [
							'<div class="'
									+ [ CSS_DAY, CSS_STATE_DEFAULT, CSS_DAY_PADDING_END, CSS_HELPER_HIDDEN ]
											.join(SPACE) + '">', 0, '</div>' ],

					TPL_CALENDAR_HEADER_TITLE = '<div class="' + CSS_TITLE + '"></div>',

					TPL_CALENDAR_MONTHDAYS = '<div class="' + [ CSS_MONTHDAYS, CSS_HELPER_CLEARFIX ].join(SPACE)
							+ '"></div>',

					TPL_CALENDAR_WEEKDAYS = '<div class="' + [ CSS_WEEKDAYS, CSS_HELPER_CLEARFIX ].join(SPACE)
							+ '"></div>',

					TPL_BUFFER_WEEKDAYS = [ '<div class="' + CSS_WEEK + '">', 0, '</div>' ],

					TPL_BUFFER_MONTH_DAYS = [
							'<a href="#" class="' + [ CSS_DAY, CSS_DAY_MONTH, CSS_STATE_DEFAULT ].join(SPACE) + '">',
							0, '</a>' ];

					/**
					 * <p>
					 * <img src="assets/images/aui-calendar/main.png"/>
					 * </p>
					 *
					 * A base class for Calendar, providing:
					 * <ul>
					 * <li>Widget Lifecycle (initializer, renderUI, bindUI,
					 * syncUI, destructor)</li>
					 ...
					 *
					 * Check the list of <a
					 * href="Calendar.html#configattributes">Configuration
					 * Attributes</a> available for Calendar.
					 *
					 * @class Calendar
					 * @param config
					 *            {Object} Object literal specifying widget
					...
					var Calendar = A.Component.create({
						/**
						 * Static property provides a string to identify the
						 * class.
						 *
						...
						ATTRS : {
							/**
							 * Wheather displays the "none" link on the Calendar
							 * footer.
							 *
							 * @attribute allowNone
							 * @default true
							...
							/**
							 * NodeList containing all the DOM elements for each
							 * blank day. If not specified try to query using
							 * HTML_PARSER an element inside contentBox which
							 * matches <code>aui-calendar-day-blank</code>.
							 *
							 * @attribute blankDays
							...
							currentMonth : {
								setter : '_setMonth',
								value : (new PersianDate()).getMonth()
							},
							...
							currentYear : {
								setter : '_setYear',
								value : (new PersianDate()).getFullYear()
							},

							/**
							 * The default date format string which can be
							 * overriden for localization support. The format
							 * must be valid according to <a
							 * href="DataType.Date.html">A.DataType.Date.format</a>.
							 *
							...
							/**
							 * Dates which the calendar will show as selected by
							 * default.
							 *
							 * @attribute dates
							...
							/**
							 * DOM node reference to be the header of the
							 * Calendar. If not specified try to query using
							 * HTML_PARSER an element inside contentBox which
							 * matches <code>aui-calendar-hd</code>.
							 *
							...
							/**
							 * DOM node reference to be the title of the
							 * Calendar. If not specified try to query using
							 * HTML_PARSER an element inside contentBox which
							 * matches <code>aui-calendar-title</code>.
							 *
							...
							/**
							 * DOM node reference to be the icon next of the
							 * Calendar. If not specified try to query using
							 * HTML_PARSER an element inside contentBox which
							 * matches <code>aui-calendar-prev</code>.
							 *
							...
							iconNextNode : {
								valueFn : function() {
									...
									return A.Node.create(L.sub(TPL_CALENDAR_NEXT, {
										next : strings[NEXT]
									}));
								}
							},
							...
							/**
							 * DOM node reference to be the icon prev of the
							 * Calendar. If not specified try to query using
							 * HTML_PARSER an element inside contentBox which
							 * matches <code>aui-calendar-prev</code>.
							 *
							...
							iconPrevNode : {
								valueFn : function() {
									...
									return A.Node.create(L.sub(TPL_CALENDAR_PREV, {
							...
							/**
							 * Maximum allowable date. Values supported by the
							 * Date constructor are supported.
							 *
							 * @attribute maxDate
							 * @default null
							 * @type String | Date
							...
							/**
							 * Minimum allowable date. Values supported by the
							 * Date constructor are supported.
							 *
							 * @attribute minDate
							 * @default null
							...
							/**
							 * NodeList reference containing the days of the
							 * month of the Calendar. If not specified try to
							 * query using HTML_PARSER an element inside
							 * contentBox which matches
							 * <code>aui-calendar-day</code>.
							 *
							 * @attribute monthDays
							 * @default Generated div element.
							 * @type NodeList
							...
							/**
							 * DOM node reference which contains all month days
							 * nodes of the Calendar. If not specified try to
							 * query using HTML_PARSER an element inside
							 * contentBox which matches
							 * <code>aui-calendar-monthdays</code>.
							 *
							...
							/**
							 * DOM node reference to be the "none" link of the
							 * Calendar. If not specified try to query using
							 * HTML_PARSER an element inside contentBox which
							 * matches <code>aui-calendar-title</code>.
							 *
							...
							noneLinkNode : {
								valueFn : function() {
									...
									return A.Node.create(L.sub(TPL_CALENDAR_NONE_LINK, {
										none : strings[NONE]
									}));
								}
							},
							...
							/**
							 * If true set the selected date with the correct <a
							 * href="Calendar.html#config_dateFormat">dateFormat</a>
							 * to the value of the input field which is hosting
							 * the Calendar.
							 *
							 * @attribute setValue
							 * @default true
							...
							/**
							 * Wheather displays the "today" link on the
							 * Calendar footer.
							 *
							 * @attribute showToday
							 * @default true
							...
							/**
							 * DOM node reference to be the "today" link of the
							 * Calendar. If not specified try to query using
							 * HTML_PARSER an element inside contentBox which
							 * matches <code>aui-calendar-title</code>.
							 *
							...
							todayLinkNode : {
								valueFn : function() {
									...
									return A.Node.create(L.sub(TPL_CALENDAR_TODAY_LINK, {
										today : strings[TODAY]
									}));
								}
							},
							...
							/**
							 * NodeList reference containing the days of the
							 * week of the Calendar. If not specified try to
							 * query using HTML_PARSER an element inside
							 * contentBox which matches
							 * <code>aui-calendar-week</code>.
							 *
							 * @attribute weekDays
							 * @default Generated div element.
							 * @type NodeList
							...
							/**
							 * DOM node reference which contains all week days
							 * nodes of the Calendar. If not specified try to
							 * query using HTML_PARSER an element inside
							 * contentBox which matches
							 * <code>aui-calendar-weekdays</code>.
							 *
						...
						/**
						 * Object hash, defining how attribute values are to be
						 * parsed from markup contained in the widget's content
						 * box.
						 *
						...
						prototype : {
							/**
							 * Construction logic executed during Calendar
							...
							/**
							 * Loop each date from <a
							 * href="Calendar.html#config_dates">dates</a> and
							 * executes a callback.
							 *
							 * @method eachSelectedDate
							 * @param {function}
							 *            fn Callback to be executed for each
							 *            date.
							 * @param {Dates}
							 *            dates Optional dates Array to loop
							 *            through. If not passed it will use the
							 *            <a
							...
							/**
							 * Get the first day of the month of the passed
							 * year.
							 *
							 ...
							 * @param {Number}
							 *            month 0 for January 11 for December.
							 * @return {Number}
							 */
							...
							getCurrentDate : function(offsetYear, offsetMonth, offsetDay) {
								...
								return DateMath.getDate(date.year + toInt(offsetYear), date.month + toInt(offsetMonth),
										date.day + toInt(offsetDay));
							},

							/**
							 * Get the number of days in the passed year and
							 * month.
							 *
							...
							/**
							 * Get an Array with selected dates with detailed
							...
							/**
							 * Get the first day of week of the passed year and
							 * month.
							 *
							...
							/**
							 * Get the selected dates formatted by the <a
							 * href="Calendar.html#config_dateFormat">dateFormat</a>.
							 *
							...
							/**
							 * Check if the passed date is out of range.
							 * Compared with the <a
							 * href="Calendar.html#config_minDate">minDate</a>
							 * and <a
							...
							isOutOfRangeDate : function(date) {
								...
								if ((!minDate && !maxDate) || instance._compareDates(date, minDate)
							 ...
							 * @param {Number}
							 *            offset Offset of the number of months
							 *            to navigate. Could be a positive or a
							 *            negative offset.
							 */
							...
							/**
							 * Create the DOM structure for the Calendar.
							 * Lifecycle.
							 *
							 * @method renderUI
							 * @protected
							...
							renderUI : function() {
								...
								// creating properties references for
								// performance
							...
							selectCurrentDate : function() {
								...
								if (!instance.isAlreadySelected(currentDate)) {
									...
									// if is single selection reset the selected
									// dates
							...
							/**
							 * Navigate to the next month. Fired from the next
							 * icon on the Calendar header.
							 *
							...
							/**
							 * Navigate to the previous month. Fired from the
							 * previous icon on the Calendar header.
							 *
							...
							selectToday : function() {
								...
								instance.set(DATES, [ new PersianDate() ]);
							},

							/**
							 * Update the currentDay, currentMonth and
							 * currentYear values.
							 *
							...
							setCurrentDate : function(date) {
								...
								if (isDate(date) || date instanceof PersianDate) { //modified//
									// update the current values to the last
									// selected date
							...
							_bindDelegate : function() {
								...
								headerContentNode.delegate('click', instance.selectNextMonth, DOT
										+ CSS_ICON_CIRCLE_TRIANGLE_R, instance);
								headerContentNode.delegate('click', instance.selectPrevMonth, DOT
										+ CSS_ICON_CIRCLE_TRIANGLE_L, instance);

								boundingBox.delegate('click', instance._preventDefaultFn, ANCHOR);
								boundingBox.delegate('click', A.bind(instance.selectToday, instance), DOT
										+ CSS_CALENDAR_LINK_TODAY);
								boundingBox.delegate('click', A.bind(instance.clear, instance), DOT
										+ CSS_CALENDAR_LINK_NONE);
								boundingBox.delegate('click', A.bind(instance._onClickDays, instance), DOT + CSS_DAY);
								boundingBox.delegate('mouseenter', A.bind(instance._onMouseEnterDays, instance), DOT
										+ CSS_DAY);
								boundingBox.delegate('mouseleave', A.bind(instance._onMouseLeaveDays, instance), DOT
										+ CSS_DAY);
							...
							_checkNodeRange : function(node, date) {
								...
								node.toggleClass(CSS_CALENDAR_DISABLED, instance.isOutOfRangeDate(date));
							},
							...
							_createEvents : function() {
								...
								// create publish function for kweight
								// optimization
							...
							/**
							 * Get the day name of the passed weekDay from the
							 * locale map.
							 *
							 * @method _getDayName
							 * @param {Number}
							...
							/**
							 * Get a short day name of the passed weekDay from
							 * the locale map.
							 *
							...
							/**
							 * Get a very short day name of the passed weekDay
							 * from the locale map.
							 *
							...
							/**
							 * Get the locale map containing the respective
							 * values for the <a
							 * href="Widget.html#config_locale">locale</a>
							 * used.
							 *
							 * <pre><code>
							 ...
							 * 	A: ['Domingo','Segunda-feira','Ter&amp;ccedila-feira','Quarta-feira','Quinta-feira','Sexta-feira','Sabado'],
							 * 	b: ['Jan','Fev','Mar','Abr','Mai','Jun', 'Jul','Ago','Set','Out','Nov','Dez'],
							 * 	B: ['Janeiro','Fevereiro','Mar&amp;ccedilo','Abril','Maio','Junho', 'Julho','Agosto','Setembro','Outubro','Novembro','Dezembro'],
							 * 	c: '%a %d %b %Y %T %Z',
							 * 	p: ['AM', 'PM'],
							 * 	P: ['am', 'pm'],
							 * 	r: '%I:%M:%S %p',
							...
							/**
							 * Get a month name of the passed month from the
							 * locale map.
							 *
							...
							/**
							 * Get a short month name of the passed month from
							 * the locale map.
							 *
							...
							/**
							 * Get the number of days with overlaps the first
							 * day of the month and the first day of the first
							 * week of the month.
							 *
							...
							_getMonthOverlapDaysOffset : function() {
								...
								return Math.abs(DateMath.getDayOffset(instance.getFirstDayOfWeek(), instance
										.findMonthStart()));
							},

							/**
							 * Object data containing all the information needed
							 * to the select event.
							 *
							 ...
							 * @param {EventFacade}
							 *            event calendar:select event facade
							 * @protected
							 */
							...
							/**
							 * Returns an Object with the current day, month and
							 * year.
							 *
							...
							/**
							 * Render Calendar DOM blank days elements. Blank
							 * days are used to align with the week day column.
							 *
							...
							_renderBlankDays : function() {
								...
								instance.blankDays.appendTo(instance.monthDaysNode);
							},
							...
							_renderIconControls : function() {
								...
								instance.headerContentNode.append(instance.iconNextNode);

								instance.headerContentNode.append(instance.iconPrevNode);
							},
							...
							_renderMonthDays : function() {
								...
								instance.monthDays.appendTo(instance.monthDaysNode);
							},

							/**
							 * Render Calendar DOM padding days elements.
							 * Padding days are used to show other month day
							 * values.
							 *
							...
							_renderPaddingDaysEnd : function() {
								...
								instance.paddingDaysEnd.appendTo(instance.monthDaysNode);
							},
							...
							_renderPaddingDaysStart : function() {
								...
								instance.paddingDaysStart.appendTo(instance.monthDaysNode);
							},
							...
							_renderTitleNode : function() {
								...
								instance.headerContentNode.append(instance.headerTitleNode);
							},
							...
							_renderWeekDays : function() {
								...
								instance.weekDays.appendTo(instance.weekDaysNode);
							},
							...
							_setDates : function(value) {
								...
								instance.setCurrentDate(value[value.length - 1]);
							...
							/**
							 * Setter for the <a
							 * href="Calendar.html#config_dates">currentDay</a>
							 * attribute.
							 *
							 * @method _setDay
							 * @param int
							...
							/**
							 * Setter for the <a
							 * href="Calendar.html#config_maxDates">maxDates</a>
							 * or <a
							 * href="Calendar.html#config_mainDates">minDates</a>
							 * attributes.
							 *
							...
							/**
							 * Setter for the <a
							 * href="Calendar.html#config_dates">currentMonth</a>
							 * attribute.
							 *
							 * @method _setMonth
							 * @param int
							...
							/**
							 * Setter for the <a
							 * href="Calendar.html#config_dates">currentYear</a>
							 * attribute.
							 *
							 * @method _setYear
							 * @param int
							...
							_syncMonthDays : function() {
								...
								// Sync month days
								instance.monthDays.each(function(node, index) {
							...
							_syncPaddingEnd : function() {
								...
								if (instance.get(SHOW_OTHER_MONTH)) {
									...
									var totalVisiblePaddingEnd = (INT_MATRIX_DAYS_LENGTH - (instance
											._getMonthOverlapDaysOffset() + instance.getDaysInMonth()));

									// Sync blank or padding start nodes
									instance.paddingDaysEnd.each(function(node, index) {
							...
							_syncPaddingStart : function() {
								...
								// Sync blank or padding start nodes
								paddingNodes.each(function(node, index) {
							...
							_syncSelectedDays : function(dates) {
								...
								instance.eachSelectedDate(function(date, index) {
									var canSelectDays = (currentMonth == date.getMonth())
							...
							_syncView : function() {
								...
								instance._uiSetShowOtherMonth(instance.get(SHOW_OTHER_MONTH));
							},

							/**
							 * Sync the UI of the Calendar when showToday
							 * attribute change.
							 *
							...
							/**
							 * Sync the UI of the Calendar when dates attribute
							 * change.
							 *
							 * @method _uiSetDates
							 * @protected
							...
							/**
							 * Sync the UI of the Calendar when showOtherMonth
							 * attribute change.
							 *
							...
							/**
							 * Default value for blankDays attribute, passed as
							 * valueFn.
							 *
							...
							/**
							 * Default value for monthDays attribute, passed as
							 * valueFn.
							 *
							...
							/**
							 * Default value for paddingDaysEnd attribute,
							 * passed as valueFn.
							 *
							...
							/**
							 * Default value for paddingDaysStart attribute,
							 * passed as valueFn.
							 *
							...
							/**
							 * Default value for weekDays attribute, passed as
							 * valueFn.
							 *
					...
					skinnable : true,
					requires : [ 'aui-base', 'aui-datatype', 'widget-stdmod', 'datatype-date', 'widget-locale' ]
				});
