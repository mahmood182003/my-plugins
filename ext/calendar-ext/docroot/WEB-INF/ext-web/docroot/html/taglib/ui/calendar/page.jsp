...
<div class="taglib-calendar">
	...
	<tr>
		...
		<%
		int shift = Calendar.SUNDAY - selCal.getFirstDayOfWeek() + 7;
		dayOfWeek = (dayOfWeek + shift) % 7; // rotate the day leftward
		dayOfWeek = (dayOfWeek == 0) ? 7 : dayOfWeek;

		//if (selCal.getFirstDayOfWeek() == Calendar.SATURDAY) {
		 /* 	if (dayOfWeek == 6) { // if it is weekend
				dayOfWeek = 7;
			}
			else {
				dayOfWeek ++;
